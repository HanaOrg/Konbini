...
type EXTENDED_LOCKFILE =
    | (Extract<KONBINI_PKG_LOCKFILE, { scope: "std" }> & { path: string })
    | (Extract<KONBINI_PKG_LOCKFILE, { scope: Exclude<KPS_SOURCE, "std"> }> & { path: string });
