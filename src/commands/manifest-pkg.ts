...
import { CATEGORIES, type CATEGORY, type KONBINI_MANIFEST, type LICENSE } from "../types/manifest";
...
export async function generateManifest() {
    ...
    const author_id: AUTHOR_ID = (await prompt(
    ...
    const manifest: KONBINI_MANIFEST = {
        ...
        repository,
        platforms: {
            linux64: validate(platLinux64) ? platLinux64 : null,
            linuxARM: validate(platLinuxARM) ? platLinuxARM : null,
            mac64: validate(platMac64) ? platMac64 : null,
            macARM: validate(platMacARM) ? platMacARM : null,
            win64: validate(platWin64) ? platWin64 : null,
        },
    };
