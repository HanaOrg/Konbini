            ...
            <div className="app-main-cont">
                ...
                <div className="flex flex-row w-full gap-2">
                    <div
                        ...
                        className="cursor-pointer text-white font-bold text-2xl text-center p-4 w-full  bg-black hover:bg-[#222]"
                    >
                        Vercel
                    </div>
                    <div
                        onClick={() => (window.location.href = "https://upstash.com")}
                        className="cursor-pointer text-black font-bold text-2xl text-center p-4 w-full  bg-[#6ee7b7] hover:bg-[#499a7a]"
                    >
                        Upstash
                    </div>
                    <div
                        onClick={() => (window.location.href = "https://bun.sh")}
                        className="cursor-pointer text-black font-bold text-2xl text-center p-4 w-full  bg-[#f9f1e1] hover:bg-[#aca69b]"
                    >
                        BunJS
                    </div>
                    <div
                        onClick={() => (window.location.href = "https://www.clamav.net")}
                        className="cursor-pointer text-black font-bold text-2xl text-center p-4 w-full  bg-[#ef3e42] hover:bg-[#a22a2c]"
                    >
                        ClamAV
                    </div>
                    <div
