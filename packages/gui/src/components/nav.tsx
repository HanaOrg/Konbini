...
export default function Nav() {
    ...
    return (
        <nav className="py-6 px-14 flex flex-row items-center justify-between">
            ...
            <form
                action={"/search"}
                className="border border-[#FFFFFF17] hover:bg-[#FFFFFF1F] focus:bg-[#FFFFFF2F] bg-[#FFFFFF14] focus:border focus:border-[#FFFFFF5A] rounded-lg flex flex-row items-center pl-4"
            >
