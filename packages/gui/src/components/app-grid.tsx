            ...
            <div className="app-grid">
                {Object.values(apps).map((app) => (
                    <a
                        ...
                        href={`/package/${app.id}`}
                        className="overflow-hidden hover:opacity-[0.9] active:scale-[0.95] active:opacity-[0.8] duration-100 p-6 border border-[#FFFFFF17] flex flex-col gap-2 relative rounded-lg"
                    >
                        {app.icon && (
                            <img
